...
def home_kb():
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="🔑 Code",callback_data="code_all"),InlineKeyboardButton(text="🏆 Top 10 Code",callback_data="top_codes")],
...
def other_menu_kb(creator=False):
    ...
    if creator:
        rows.append([InlineKeyboardButton(text="👑 Creator",callback_data="creator_dashboard"),InlineKeyboardButton(text="💸 Withdraw",callback_data="withdraw")])
    else:
